...
public class FavoritMovieListAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        Movie movie = getMovieByPosition(position);
        FavoritMovieListAdapter.MovieHolder movieHolder = (FavoritMovieListAdapter.MovieHolder) holder;
    ...
    private Movie getMovieByPosition(int position) {
        ...
        return new Movie(movieId, moviePoster, movieVoteCount, movieAvreageVote,
